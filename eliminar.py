...
with open(nombre_archivo, 'w', encoding='utf-8') as archivo:
    archivo.write("INSERT INTO `app_listas_plegables` (`id`, `codigos_grupo_investigacion`, `nombre_grupo_investigacion`, `redes_conocimiento`, `subareas_conocimiento`, `diciplina_subarea`,  `nombre_centro_formacion`) VALUES\n")
    contador = 0

    # Itera a través de los elementos de las columnas 'T' y 'V'
    for dato, dato1, dato2, dato3, dato4, dato5 in zip(df['T'], nombre['V'], nombre2['P'], nombre3['AT'], nombre4['AV'], nombre5['F']):
        contador += 1
        ...
        dato_formateado = f"({contador}, '{dato}', '{dato1}', '{dato2}', '{dato3}', '{dato4}', '{dato5}'),\n"
